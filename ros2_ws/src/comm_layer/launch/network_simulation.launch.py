...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('input_topic', default_value='/uav_1/info'),
        DeclareLaunchArgument('output_topic', default_value='/uav_1/info_sim'),
        ...
        DeclareLaunchArgument('blackout_duration_sec', default_value='0.0'),
